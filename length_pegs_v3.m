...
if loadData == 1
    ...
    %NucleusImg = tiffreadVolume(sprintf('data/%s-10nm-EC.tif',dataName)); % pericyte
end
...
for i = 1:n_peg
    ...
    peg_length(i) = rp_peg(i).BoundingBox(6) * dz;
...
for l = 1 : n_peg
    fprintf('[%g] Peg length (nm): %g\n\n',l,peg_length(l))
end

csvwrite(sprintf('%s/pegLengths.csv', dataName), peg_length)
